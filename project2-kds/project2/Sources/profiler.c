...
void testMemmove() {
	results[MEMMOVE][TEST_RESULT_10] = _testMemmove(TEST_LENGTH_10);
	results[MEMMOVE][TEST_RESULT_100] = _testMemmove(TEST_LENGTH_100);
	results[MEMMOVE][TEST_RESULT_1000] = _testMemmove(TEST_LENGTH_100);
	results[MEMMOVE][TEST_RESULT_5000] = _testMemmove(TEST_LENGTH_5000);
}
